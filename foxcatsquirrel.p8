...
function draw_levels()
 ...
 -- splash.sp=92
  ...
  pset(rnd(flr(60)),rnd(flr(8))+70,7)
  pset(rnd(flr(60)),rnd(flr(8))+70,12)
  pset(rnd(flr(60)),rnd(flr(8))+70,7)
  spr(193,10,64) -- island  
  spr(ship.sp,ship.x,ship.y)
  circfill(99,134,80,11) -- far hill
  circ(99,134,80,1) -- far outline
...

__label__
