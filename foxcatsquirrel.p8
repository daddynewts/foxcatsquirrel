...
function test_ui()
-- print("count: "..count,cam_x+1,17,7) 
...
function collision_enemies()
 ...
 for skull in all(skulls) do
  ...
  if skullchase==false then
   skull.x-=cos(skullangle)-((skull.x-shockwave_x)/(20+count))
   skull.y-=sin(skullangle)-((skull.y-shockwave_y)/(20+count))
 --  skull.x-=cos(skullangle)-((skull.x-shockwave_x)/(40+count))
 --  skull.y-=sin(skullangle)-((skull.y-shockwave_y)/(10+count))
 end
 ...
 for ghost in all(ghosts) do
  ...
  if ghostchase==false then
   ghost.x-=cos(2*ghostangle)-((ghost.x-shockwave_x)/(20+count))/2
...

...

...

